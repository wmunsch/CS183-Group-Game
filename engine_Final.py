...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.health = 34 #34 is max health, or 170pixels/5
...
###### this resets slime and spawns it when changing rooms##########
    ...
    def update(self):
        ...
        if (self.newInstruction ==True):
            ...
            self.newInstruction = False
        if (self.hitbox.colliderect(player.hitbox)) and (self.frozen == False) and (player.isCasting == False):
            #print("HIT------------")
...
while not done:
        ...
        if pressed_keys[pygame.K_p]:
            state = 0
        if state == 0:
            screen.blit(pause_text, (600, 350))    
