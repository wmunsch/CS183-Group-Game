            ...
            if (self.castingTime %7 == 0):
                if (self.frameOn < 7):
                    ...
                    if (self.direction == 1):
                        ...
                        fireball.surf = fireball.up_ani[self.frameOn]
                    elif (self.direction == 2):
                        self.surf = self.walk_right_ani[0]
                        fireball.surf = fireball.right_ani[self.frameOn]
                    elif (self.direction == 3):
                        self.surf = self.walk_down_ani[0]
                        fireball.surf = fireball.down_ani[self.frameOn]
                    if (self.direction == 4):
                        self.surf = self.walk_left_ani[0]
                        fireball.surf = fireball.left_ani[self.frameOn]
...
class Fireball(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.animation_speed = 10
        self.down_ani = [pygame.transform.scale(pygame.image.load('graphics/fireballD1.png'),(68,60)),
            pygame.transform.scale(pygame.image.load('graphics/fireballD2.png'),(68,60)),
            pygame.transform.scale(pygame.image.load('graphics/fireballD3.png'),(68,60)),
            pygame.transform.scale(pygame.image.load('graphics/fireballD4.png'),(68,60))]
        self.left_ani = [pygame.transform.scale(pygame.image.load('graphics/fireballL1.png'),(68,60)),
            pygame.transform.scale(pygame.image.load('graphics/fireballL1.png'),(68,60)),
            pygame.transform.scale(pygame.image.load('graphics/fireballL1.png'),(68,60)),
            pygame.transform.scale(pygame.image.load('graphics/fireballL1.png'),(68,60))]
        self.up_ani = [pygame.transform.scale(pygame.image.load('graphics/fireballU1.png'),(68,60)),
            pygame.transform.scale(pygame.image.load('graphics/fireballU2.png'),(68,60)),
            pygame.transform.scale(pygame.image.load('graphics/fireballU3.png'),(68,60)),
            pygame.transform.scale(pygame.image.load('graphics/fireballU4.png'),(68,60))]
        self.right_ani = [pygame.transform.scale(pygame.image.load('graphics/fireballR1.png'),(68,60)),
            pygame.transform.scale(pygame.image.load('graphics/fireballR1.png'),(68,60)),
            pygame.transform.scale(pygame.image.load('graphics/fireballR1.png'),(68,60)),
            pygame.transform.scale(pygame.image.load('graphics/fireballR1.png'),(68,60))]
...
while not done:
        ...
        if (player.castingFireball == True):
            fireball.update()
